...
$(function() {
    ...
    const days = attendance[Object.keys(attendance)[0]].length;
...
// TODO: this should be canged to a event listener
    function checkBoxes() {
...
//TODO: This should be changed to be called every time when one box is clicked
